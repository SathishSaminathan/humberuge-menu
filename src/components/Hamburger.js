...
const Hamburger = ({state}) => {
    ...
    const staggerText = (node1, node2, nod3) => {
        gsap.from([node1, node2, nod3], {
            duration: 0.8,
            y: 100,
            delay: 0.1,
            ease: 'power3.inOut',
                ...
                <div className="wrapper">
                    <div className="menu-links">
                        ...
                        <div ref={el => (info = el)} className="info">
                            <h3>Our Promise</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, porro. Lorem ipsum
                                dolor sit amet, consectetur adipisicing elit. Aliquam dicta doloremque facere in iste?
                                Aspernatur aut nam porro quisquam sed.
                            </p>
